...
# Executed as a standalone Python script in a tmux session for long-running training (random seed = 999)
...
seed = 999 # setting random seed for reproducible training
...
for epoch in range(epochs):
    ...
    history["train_acc"].append(train_acc)    # Saving history 
